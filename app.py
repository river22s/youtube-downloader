...
# تعديل ذكي: إذا كان المجلد موجوداً على جهازك الشخصي سيقرأه، وإذا رُفع أونلاين سيتخطاه ويعتمد على السيرفر
...
def download():
    ...
    try:
        ...
        if file_format == 'mp4':
            # 1. جلب أعلى جودة فيديو ممكنة (صورة فقط) لتفادي قيود الجودة
            ...
            # تحميل الملفين مؤقتاً في مجلد المشروع
            ...
            # تنظيف وحذف الملفات المؤقتة فوراً من السيرفر أو الجهاز
